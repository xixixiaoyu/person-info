...
- 流畅的过渡动画（200-300ms 缓动函数）
- 微交互反馈（按钮点击涟漪效果、卡片悬停微弹）
- 自然的滚动体验（smooth scroll）
- 无感加载（骨架屏 + 渐显动画）
...
**核心内容区**（顶部 padding 56px，底部 padding 80px）：
